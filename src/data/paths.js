  ...
  },
  {
    ...
    phases: [
      ...
      { t: { zh: '深入 LLM', en: 'Inside the LLM', ja: 'LLM の内部' },
        steps: [{ k: 'course', ref: 'tokenizer' }, { k: 'course', ref: 'embedding' }, { k: 'course', ref: 'transformer' }, { k: 'course', ref: 'llm' }, { k: 'course', ref: 'model-size' }, { k: 'course', ref: 'model-knowledge' }, { k: 'course', ref: 'context-window' }, { k: 'course', ref: 'inference' }, { k: 'iv', ref: 'attention-compute' }, { k: 'iv', ref: 'multi-head' }, { k: 'iv', ref: 'positional-encoding' }, { k: 'iv', ref: 'what-model-stores' }] },
  ...
  },
  {
    ...
    phases: [
      ...
      { t: { zh: '注意力與 Transformer', en: 'Attention and the Transformer', ja: '注意機構と Transformer' },
        steps: [{ k: 'course', ref: 'transformer' }, { k: 'iv', ref: 'attention-compute' }, { k: 'iv', ref: 'multi-head' }, { k: 'iv', ref: 'positional-encoding' }, { k: 'iv', ref: 'transformer-vs-rnn' }] },
