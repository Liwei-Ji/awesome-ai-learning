  ...
  },
  {
    ...
    phases: [
      ...
      { t: { zh: '深入 LLM', en: 'Inside the LLM', ja: 'LLM の内部' },
        steps: [{ k: 'course', ref: 'tokenizer' }, { k: 'course', ref: 'embedding' }, { k: 'course', ref: 'rnn' }, { k: 'course', ref: 'transformer' }, { k: 'course', ref: 'llm' }, { k: 'course', ref: 'model-size' }, { k: 'course', ref: 'model-knowledge' }, { k: 'course', ref: 'context-window' }, { k: 'course', ref: 'inference' }, { k: 'iv', ref: 'attention-compute' }, { k: 'iv', ref: 'multi-head' }, { k: 'iv', ref: 'positional-encoding' }, { k: 'iv', ref: 'what-model-stores' }, { k: 'iv', ref: 'emergence' }] },
      { t: { zh: '訓練與調校', en: 'Training and tuning', ja: '学習と調整' },
        steps: [{ k: 'course', ref: 'training' }, { k: 'course', ref: 'backprop' }, { k: 'course', ref: 'pretraining' }, { k: 'course', ref: 'fine-tuning' }, { k: 'course', ref: 'reasoning' }, { k: 'iv', ref: 'rlhf-why' }, { k: 'iv', ref: 'finetune-vs-rag' }, { k: 'iv', ref: 'lora' }, { k: 'iv', ref: 'catastrophic-forgetting' }, { k: 'iv', ref: 'scaling-law' }, { k: 'iv', ref: 'dpo-pipeline' }] },
  ...
  },
  {
    ...
    phases: [
      ...
      { t: { zh: '大模型與記憶', en: 'The model and memory', ja: 'モデルと記憶' },
        steps: [{ k: 'course', ref: 'llm' }, { k: 'course', ref: 'model-size' }, { k: 'course', ref: 'model-knowledge' }, { k: 'iv', ref: 'what-model-stores' }, { k: 'iv', ref: 'emergence' }] },
      { t: { zh: '推論', en: 'Inference', ja: '推論' },
        steps: [{ k: 'course', ref: 'context-window' }, { k: 'course', ref: 'inference' }, { k: 'iv', ref: 'train-vs-infer' }, { k: 'iv', ref: 'faster-inference' }, { k: 'iv', ref: 'context-window' }] },
    ],
  },
  {
    id: 'train-tune',
    ...
    phases: [
      ...
      { t: { zh: '從模型到 ChatGPT', en: 'From model to ChatGPT', ja: 'モデルから ChatGPT へ' },
        steps: [{ k: 'course', ref: 'pretraining' }, { k: 'course', ref: 'fine-tuning' }, { k: 'iv', ref: 'rlhf-why' }, { k: 'iv', ref: 'why-not-pretrain' }, { k: 'iv', ref: 'dpo-pipeline' }] },
  ...
  },
  {
    ...
    phases: [
      { t: { zh: '架構基礎', en: 'Architecture basics', ja: '構成の基礎' },
        steps: [{ k: 'course', ref: 'integration' }, { k: 'iv', ref: 'agent-vs-workflow' }, { k: 'iv', ref: 'design-doc-qa' }, { k: 'iv', ref: 'design-data-pipeline' }] },
      ...
      { t: { zh: '成本與可靠', en: 'Cost and reliability', ja: 'コストと信頼性' },
        steps: [{ k: 'iv', ref: 'design-cost' }, { k: 'iv', ref: 'guardrails' }, { k: 'iv', ref: 'data-leakage' }, { k: 'iv', ref: 'design-build-vs-buy' }, { k: 'iv', ref: 'design-latency-scale' }] },
