  ...
  },
  {
    ...
    phases: [
      ...
      { t: { zh: '訓練與調校', en: 'Training and tuning', ja: '学習と調整' },
        steps: [{ k: 'course', ref: 'training' }, { k: 'course', ref: 'backprop' }, { k: 'course', ref: 'pretraining' }, { k: 'course', ref: 'fine-tuning' }, { k: 'iv', ref: 'rlhf-why' }, { k: 'iv', ref: 'finetune-vs-rag' }, { k: 'iv', ref: 'lora' }, { k: 'iv', ref: 'catastrophic-forgetting' }, { k: 'iv', ref: 'scaling-law' }, { k: 'iv', ref: 'dpo-pipeline' }] },
