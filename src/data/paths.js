  ...
  },
  {
    ...
    phases: [
      ...
      { t: { zh: '接資料與工具', en: 'Add data and tools', ja: 'データとツールを繋ぐ' },
        steps: [{ k: 'course', ref: 'rag' }, { k: 'course', ref: 'knowledge-graph' }, { k: 'iv', ref: 'rag-documents' }, { k: 'iv', ref: 'chunking' }, { k: 'course', ref: 'memory' }, { k: 'course', ref: 'mcp' }, { k: 'course', ref: 'skills' }] },
  ...
  },
  {
    ...
    phases: [
      ...
      { t: { zh: '應用鏈', en: 'The application chain', ja: '応用チェーン' },
        steps: [{ k: 'course', ref: 'prompt' }, { k: 'iv', ref: 'prompt-craft' }, { k: 'course', ref: 'rag' }, { k: 'course', ref: 'knowledge-graph' }, { k: 'iv', ref: 'rag-documents' }, { k: 'iv', ref: 'rag-why-wrong' }, { k: 'course', ref: 'memory' }, { k: 'course', ref: 'mcp' }, { k: 'course', ref: 'agent' }, { k: 'course', ref: 'skills' }] },
  ...
  },
  {
    ...
    phases: [
      { t: { zh: '觀念', en: 'Concept', ja: '概念' },
        steps: [{ k: 'course', ref: 'rag' }, { k: 'course', ref: 'knowledge-graph' }, { k: 'iv', ref: 'finetune-vs-rag' }, { k: 'iv', ref: 'rag-documents' }] },
  ...
  },
  {
    ...
    phases: [
      ...
      { t: { zh: '工具與輸出', en: 'Tools and output', ja: 'ツールと出力' },
        steps: [{ k: 'course', ref: 'mcp' }, { k: 'course', ref: 'skills' }, { k: 'course', ref: 'orchestration' }, { k: 'iv', ref: 'agent-tools' }, { k: 'iv', ref: 'json-output' }] },
  ...
  },
  {
    ...
    phases: [
      { t: { zh: '先看整條鏈', en: 'See the whole chain', ja: '鎖全体を見る' },
        steps: [{ k: 'course', ref: 'rag' }, { k: 'course', ref: 'knowledge-graph' }, { k: 'course', ref: 'agent' }, { k: 'course', ref: 'orchestration' }, { k: 'course', ref: 'integration' }, { k: 'iv', ref: 'agent-vs-workflow' }, { k: 'iv', ref: 'design-doc-qa' }] },
